...
The website changed quite a bit through the process, but where I got to in the end was a easier to navigate version. I utlised some single colour backgrounds to help with text readability.
I moved the socials up to the navbar so they could be in the hamburger drop down for ease.
I have struggled with responsivness, but have done a lot of work to get to where it is. I will continue to improve this as I learn. Eventually too I would like to add in icons for my skills, as I learn more developing, and to have a Projects page as opposed to a Blog page. The blog page for me will become obsolete eventually.
